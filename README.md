...
- Session 1 — Intro to the project: TypeScript + React + Vite basics, simple TS examples and component setup.

[Session1](https://github.com/Griffith000/full-stack-training/tree/session-1)

-Session 2 -- explain React hooks (useState,useRef ,useEffect)
